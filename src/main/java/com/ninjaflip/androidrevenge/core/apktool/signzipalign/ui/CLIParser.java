...
public class CLIParser {
    ...
    static Options setupOptions() {
        ...
        Option outOpt = Option.builder(ARG_APK_OUT).longOpt("out").argName("path").hasArg().desc("Where the aligned/signed apks will be copied to. Must be a folder. Will create, if it does not exist.").build();
    ...
    private static void printHelp(Options options) {
        ...
        help.printHelp("signzipalign-apk-signer", "Version: " + CmdUtil.jarVersion(), options, "", true);
    }
}
